document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch(apiUrl)
        ...
        .catch(error => {
            ...
            const weatherData = document.getElementById('weather-data');
            weatherData.innerHTML = 'Failed to load weather data. Please try again later.';
        });
});
...
/*! For license information please see app.js.LICENSE */ ! function(A) {
    ...
    window.webpackHotUpdate = function(e, t) {
        ! function(e, t) {
            if (!I[e] || !f[e]) return;
            for (var n in f[e] = !1, t) Object.prototype.hasOwnProperty.call(t, n) && (H[n] = t[n]);
            0 == --c && 0 === u && v()
        }(e, t), n && n(e, t)
    };
    var o, r = !0,
    ...
    function s(t) {
        ...
        if (!n) return W;
        var r = function(e) {
                return n.hot.active ? (R[e] ? -1 === R[e].parents.indexOf(t) && R[e].parents.push(t) : (L = [t], o = e), -1 === n.children.indexOf(e) && n.children.push(e)) : L = [], W(e)
            },
            e = function(t) {
                return {
                    configurable: !0,
        ...
        for (var i in W) Object.prototype.hasOwnProperty.call(W, i) && "e" !== i && "t" !== i && Object.defineProperty(r, i, e(i));
        return r.e = function(e) {
            return "ready" === O && q("prepare"), u++, W.e(e).then(t, function(e) {
                throw t(), e
            });
    ...
    function h(e) {
        I[e] ? (f[e] = !0, c++, function(e) {
            var t = document.createElement("script");
            t.charset = "utf-8", t.src = W.p + "" + e + "." + _ + ".hot-update.js", document.head.appendChild(t)
        }(e)) : d[e] = !0
    }
    ...
    function v() {
        ...
        if (l = null, t)
            if (r) Promise.resolve().then(function() {
                ...
                var e = [];
                for (var n in H) Object.prototype.hasOwnProperty.call(H, n) && e.push(M(n));
                t.resolve(e)
            }
    }
    ...
    function g(n) {
                    ...
                    for (var a = 0; a < u.parents.length; a++) {
                        ...
                        if (c) {
                            if (c.hot._declinedDependencies[o]) return {
                                ...
                                moduleId: o,
                                parentId: l
                            }; - 1 === t.indexOf(l) && (c.hot._acceptedDependencies[o] ? (n[l] || (n[l] = []), d(n[l], [o])) : (delete n[l], t.push(l), r.push({
                                chain: s.concat([l]),
                                id: l
                            })))
                        }
        ...
        for (var f in H)
            if (Object.prototype.hasOwnProperty.call(H, f)) {
                ...
                switch ((p = H[f] ? o(i) : {
                    ...
                    case "self-declined":
                        n.onDeclined && n.onDeclined(p), n.ignoreDeclined || (h = new Error("Aborted because of self decline: " + p.moduleId + m));
                        break;
                    case "declined":
                        n.onDeclined && n.onDeclined(p), n.ignoreDeclined || (h = new Error("Aborted because of declined dependency: " + p.moduleId + " in " + p.parentId + m));
                        break;
                    case "unaccepted":
                        n.onUnaccepted && n.onUnaccepted(p), n.ignoreUnaccepted || (h = new Error("Aborted because " + i + " is not accepted" + m));
                        break;
                    case "accepted":
                ...
                if (v)
                    for (i in l[i] = H[i], d(a, p.outdatedModules), p.outdatedDependencies) Object.prototype.hasOwnProperty.call(p.outdatedDependencies, i) && (s[i] || (s[i] = []), d(s[i], p.outdatedDependencies[i]));
                g && (d(a, [p.moduleId]), l[i] = c)
            }
        var y, b = [];
        for (t = 0; t < a.length; t++) i = a[t], R[i] && R[i].hot._selfAccepted && b.push({
            module: i,
            errorHandler: R[i].hot._selfAccepted
        });
        q("dispose"), Object.keys(I).forEach(function(e) {
            !1 === I[e] && function(e) {
        ...
        for (var x, w, T = a.slice(); 0 < T.length;)
            if (i = T.pop(), u = R[i]) {
                ...
                for (N[i] = C, u.hot.active = !1, delete R[i], delete s[i], r = 0; r < u.children.length; r++) {
        ...
        for (i in s)
            if (Object.prototype.hasOwnProperty.call(s, i) && (u = R[i]))
                for (w = s[i], r = 0; r < w.length; r++) x = w[r], 0 <= (y = u.children.indexOf(x)) && u.children.splice(y, 1);
        for (i in q("apply"), _ = P, l) Object.prototype.hasOwnProperty.call(l, i) && (A[i] = l[i]);
        var D = null;
        for (i in s)
            if (Object.prototype.hasOwnProperty.call(s, i) && (u = R[i])) {
                w = s[i];
        ...
        return D ? (q("fail"), Promise.reject(D)) : (q("idle"), new Promise(function(e) {
            e(a)
        }))
    }
    var R = {};
    ...
    W.m = A, W.c = R, W.d = function(e, t, n) {
        ...
        if (W.r(n), Object.defineProperty(n, "default", {
                enumerable: !0,
                value: t
            }), 2 & e && "string" != typeof t)
            for (var r in t) W.d(n, r, function(e) {
                return t[e]
            }.bind(null, r));
        return n
    }, W.n = function(e) {
        ...
        function Qt(e) {
            ...
            E.fn = E.prototype = {
                ...
                var e, t, n, r, i, o, s = arguments[0] || {},
                    ...
                    l = arguments.length,
                    c = !1;
                for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == Qt(s) || y(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
                    if (null != (e = arguments[a]))
                        for (t in e) n = s[t], s !== (r = e[t]) && (c && r && (E.isPlainObject(r) || (i = Array.isArray(r))) ? (o = i ? (i = !1, n && Array.isArray(n) ? n : []) : n && E.isPlainObject(n) ? n : {}, s[t] = E.extend(c, o, r)) : void 0 !== r && (s[t] = r));
                return s
            }, E.extend({
            ...
            var p = function(n) {
                var e, p, x, o, i, h, d, v, w, l, c, T, C, s, S, g, a, u, m, E = "sizzle" + 1 * new Date,
                    y = n.document,
                    D = 0,
                    r = 0,
                    f = se(),
                    ...
                    if (!r && ((t ? t.ownerDocument || t : y) !== C && T(t), t = t || C, S)) {
                        ...
                        if (p.qsa && !k[e + " "] && (!g || !g.test(e))) {
                            if (1 !== f) d = t, u = e;
                                ...
                                for ((a = t.getAttribute("id")) ? a = a.replace(te, ne) : t.setAttribute("id", a = E), o = (c = h(e)).length; o--;) c[o] = "#" + a + " " + me(c[o]);
                ...
                for (e in p = oe.support = {}, i = oe.isXML = function(e) {
                        ...
                        return r !== C && 9 === r.nodeType && r.documentElement && (s = (C = r).documentElement, S = !i(C), y !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", re, !1) : n.attachEvent && n.attachEvent("onunload", re)), p.attributes = le(function(e) {
                        ...
                        }), g = g.length && new RegExp(g.join("|")), a = a.length && new RegExp(a.join("|")), t = G.test(s.compareDocumentPosition), m = t || G.test(s.contains) ? function(e, t) {
                        ...
                        if ((e.ownerDocument || e) !== C && T(e), t = t.replace($, "='$1']"), p.matchesSelector && S && !k[t + " "] && (!a || !a.test(t)) && (!g || !g.test(t))) try {
                            var n = u.call(e, t);
                        ...
                        filter: {
                            ...
                            CHILD: function(h, e, t, v, g) {
                                ...
                                return 1 === v && 0 === g ? function(e) {
                                    ...
                                    var r, i, o, s, a, l, c = m != y ? "nextSibling" : "previousSibling",
                                        u = e.parentNode,
                                    ...
                                    if (u) {
                                        ...
                                        if (l = [y ? u.firstChild : u.lastChild], y && f) {
                                            for (p = (a = (r = (i = (o = (s = u)[E] || (s[E] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] || [])[0] === D && r[1]) && r[2], s = a && u.childNodes[a]; s = ++a && s && s[c] || (p = a = 0) || l.pop();)
                                                if (1 === s.nodeType && ++p && s === e) {
                                                    i[h] = [D, a, p];
                                                    break
                                                }
                                        } else if (f && (p = a = (r = (i = (o = (s = e)[E] || (s[E] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] || [])[0] === D && r[1]), !1 === p)
                                            for (;
                                                (s = ++a && s && s[c] || (p = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== d : 1 !== s.nodeType) || !++p || (f && ((i = (o = s[E] || (s[E] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] = [D, p]), s !== e)););
                            ...
                            PSEUDO: function(e, o) {
                                ...
                                return s[E] ? s(o) : 1 < s.length ? (t = [e, e, "", o], x.setFilters.hasOwnProperty(e.toLowerCase()) ? ae(function(e, t) {
                ...
                function ye(a, e, t) {
                    ...
                    return e.first ? function(e, t, n) {
                        ...
                        if (n) {
                            ...
                            for (; e = e[l];)
                                if (1 === e.nodeType || d)
                                    if (i = (o = e[E] || (e[E] = {}))[e.uniqueID] || (o[e.uniqueID] = {}), c && c === e.nodeName.toLowerCase()) e = e[l] || e;
                                    else {
                                        if ((r = i[u]) && r[0] === D && r[1] === f) return s[2] = r[2];
                ...
                function we(p, h, v, g, m, e) {
                    return g && !g[E] && (g = we(g)), m && !m[E] && (m = we(m, e)), ae(function(e, t, n, r) {
                        var i, o, s, a = [],
                            l = [],
                            c = t.length,
                            u = e || function(e, t, n) {
                            ...
                            f = v ? m || (e ? p : c || g) ? [] : t : d;
                        if (v && v(d, f, n, r), g)
                            for (i = xe(f, l), g(i, [], n, r), o = i.length; o--;)(s = i[o]) && (f[l[o]] = !(d[l[o]] = s));
                        if (e) {
                            if (m || p) {
                                if (m) {
                                ...
                                for (o = f.length; o--;)(s = f[o]) && -1 < (i = m ? q(e, s) : a[o]) && (e[i] = !(t[i] = s))
                            }
                ...
                return ge.prototype = x.filters = x.pseudos, x.setFilters = new ge, h = oe.tokenize = function(e, t) {
                    ...
                    for (s = e, a = [], l = x.preFilter; s;) {
                        for (o in n && !(r = B.exec(s)) || (r && (s = s.slice(r[0].length) || s), a.push(i = [])), n = !1, (r = F.exec(s)) && (n = r.shift(), i.push({
                                value: n,
                                type: r[0].replace(z, " ")
                            }), s = s.slice(n.length)), x.filter) !(r = V[o].exec(s)) || l[o] && !(r = l[o](r)) || (n = r.shift(), i.push({
                            value: n,
                            type: o,
                            matches: r
                        }), s = s.slice(n.length));
                    ...
                    var n, r = [],
                        ...
                        o = k[e + " "];
                    if (!o) {
                        for (t || (t = h(e)), n = t.length; n--;)(o = Te(t[n]))[E] ? r.push(o) : i.push(o);
                        (o = k(e, function(g, m) {
                            var y = 0 < m.length,
                                b = 0 < g.length,
                                e = function(e, t, n, r, i) {
                                    ...
                                    if (l += c, y && c !== l) {
                                        ...
                                        if (e) {
                                            if (0 < l)
                                                for (; c--;) u[c] || d[c] || (d[c] = _.call(r));
                                            d = xe(d)
                                        }
                                        L.apply(r, d), i && !e && 0 < d.length && 1 < l + m.length && oe.uniqueSort(r)
                                    }
                                    return i && (D = h, w = f), u
                                };
                            return y ? ae(e) : e
                    ...
                    if (n = n || [], 1 === u.length) {
                        if (2 < (o = u[0] = u[0].slice(0)).length && "ID" === (s = o[0]).type && 9 === t.nodeType && S && x.relative[o[1].type]) {
                            if (!(t = (x.find.ID(s.matches[0].replace(Z, ee), t) || [])[0])) return n;
                            c && (t = t.parentNode), e = e.slice(o.shift().value.length)
                        }
                        for (i = V.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !x.relative[a = s.type]);)
                    ...
                    return (c || d(e, u))(r, t, !S, n, !t || K.test(e) && ve(t.parentNode) || t), n
            ...
            (E.fn.init = function(e, t, n) {
                var r, i;
                if (!e) return this;
                if (n = n || _, "string" != typeof e) return e.nodeType ? (this[0] = e, this.length = 1, this) : y(e) ? void 0 !== n.ready ? n.ready(e) : e(E) : E.makeArray(e, this);
                if (!(r = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : N.exec(e)) || !r[1] && t) return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
                if (r[1]) {
                    if (t = t instanceof E ? t[0] : t, E.merge(this, E.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : S, !0)), j.test(r[1]) && E.isPlainObject(t))
                        for (r in t) y(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                    return this
                }
                return (i = S.getElementById(r[2])) && (this[0] = i, this.length = 1), this
            }).prototype = E.fn, _ = E(S);
            ...
            E.Callbacks = function(r) {
                ...
                var n, e, t, i, o = [],
                    ...
                    c = {
                        ...
                        fireWith: function(e, t) {
                            return i || (t = [e, (t = t || []).slice ? t.slice() : t], s.push(t), n || l()), this
                        },
                        fire: function() {
                        ...
                        s = {
                            ...
                            then: function(t, n, r) {
                                        ...
                                        var n = this,
                                            ...
                                            e = function() {
                                                ...
                                                if (!(i < l)) {
                                                    ...
                                                    t = e && ("object" == Qt(e) || "function" == typeof e) && e.then, y(t) ? a ? t.call(e, c(l, o, P, a), c(l, o, I, a)) : (l++, t.call(e, c(l, o, P, a), c(l, o, I, a), c(l, o, P, o.notifyWith))) : (s !== P && (n = void 0, r = [e]), (a || o.resolveWith)(n, r))
                                                }
                                            },
                                            t = a ? e : function() {
                                                try {
                                                    ...
                                                    E.Deferred.exceptionHook && E.Deferred.exceptionHook(e, t.stackTrace), l <= i + 1 && (s !== I && (n = void 0, r = [e]), o.rejectWith(n, r))
                                                }
                                            };
                                ...
                                return E.Deferred(function(e) {
                                    o[0][3].add(c(0, e, y(r) ? r : P, e.notifyWith)), o[1][3].add(c(0, e, y(t) ? t : P)), o[2][3].add(c(0, e, y(n) ? n : I))
                                }).promise()
                            },
                            promise: function(e) {
                ...
                when: function(e) {
                    ...
                    if (n <= 1 && (M(e, o.done(s(t)).resolve, o.reject, !n), "pending" === o.state() || y(i[t] && i[t].then))) return o.then();
            ...
            function z() {
                S.removeEventListener("DOMContentLoaded", z), C.removeEventListener("load", z), E.ready()
            }
            ...
            }), E.ready.then = W.then, "complete" === S.readyState || "loading" !== S.readyState && !S.documentElement.doScroll ? C.setTimeout(E.ready) : (S.addEventListener("DOMContentLoaded", z), C.addEventListener("load", z));
            var B = function e(t, n, r, i, o, s, a) {
                    ...
                    else if (void 0 !== i && (o = !0, y(i) || (a = !0), u && (n = a ? (n.call(t, i), null) : (u = n, function(e, t, n) {
                            return u.call(E(e), n)
                        })), n))
            ...
            E.extend({
                ...
                data: function(n, e) {
                    var t, r, i, o = this[0],
                        s = o && o.attributes;
                    if (void 0 !== n) return "object" == Qt(n) ? this.each(function() {
                        G.set(this, n)
                    }) : B(this, function(e) {
                        var t;
                        if (o && void 0 === e) {
                    ...
                    if (this.length && (i = G.get(o), 1 === o.nodeType && !Q.get(o, "hasDataAttrs"))) {
                        for (t = s.length; t--;) s[t] && 0 === (r = s[t].name).indexOf("data-") && (r = U(r.slice(5)), Z(o, r, i[r]));
            ...
            function ae(e, t) {
                for (var n, r, i = [], o = 0, s = e.length; o < s; o++)(r = e[o]).style && (n = r.style.display, t ? ("none" === n && (i[o] = Q.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && re(r) && (i[o] = (d = c = l = void 0, c = (a = r).ownerDocument, u = a.nodeName, (d = se[u]) || (l = c.body.appendChild(c.createElement(u)), d = E.css(l, "display"), l.parentNode.removeChild(l), "none" === d && (d = "block"), se[u] = d)))) : "none" !== n && (i[o] = "none", Q.set(r, "display", n)));
                var a, l, c, u, d;
            ...
            function me(e, t, n, r, i) {
                ...
                for (d.textContent = "", p = 0; o = f[p++];)
                    ...
                    else if (c = E.contains(o.ownerDocument, o), s = fe(d.appendChild(o), "script"), c && pe(s), n)
            ...
            E.event = {
                ...
                add: function(t, e, n, r, i) {
                    ...
                    if (g)
                        for (n.handler && (n = (o = n).handler, i = o.selector), i && E.find.matchesSelector(ye, i), n.guid || (n.guid = E.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function(e) {
                                return void 0 !== E && E.event.triggered !== e.type ? E.event.dispatch.apply(t, arguments) : void 0
                            }), c = (e = (e || "").match(H) || [""]).length; c--;) p = v = (a = we.exec(e[c]) || [])[1], h = (a[2] || "").split(".").sort(), p && (d = E.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, d = E.event.special[p] || {}, u = E.extend({
                            type: p,
                            origType: v,
                            data: r,
                            handler: n,
                            ...
                            namespace: h.join(".")
                        }, o), (f = l[p]) || ((f = l[p] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(t, r, h, s) || t.addEventListener && t.addEventListener(p, s)), d.add && (d.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), i ? f.splice(f.delegateCount++, 0, u) : f.push(u), E.event.global[p] = !0)
                },
                remove: function(e, t, n, r, i) {
                    var o, s, a, l, c, u, d, f, p, h, v, g = Q.hasData(e) && Q.get(e);
                    if (g && (l = g.events)) {
                        for (c = (t = (t || "").match(H) || [""]).length; c--;)
                            if (p = v = (a = we.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), p) {
                                for (d = E.event.special[p] || {}, f = l[p = (r ? d.delegateType : d.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = f.length; o--;) u = f[o], !i && v !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || r && r !== u.selector && ("**" !== r || !u.selector) || (f.splice(o, 1), u.selector && f.delegateCount--, d.remove && d.remove.call(e, u));
                    ...
                    if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                        for (s = E.event.handlers.call(this, a, c), t = 0;
                            ...
                            for (a.currentTarget = i.elem, n = 0;
                                (o = i.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !a.rnamespace.test(o.namespace) || (a.handleObj = o, a.data = o.data, void 0 !== (r = ((E.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, l)) && !1 === (a.result = r) && (a.preventDefault(), a.stopPropagation()));
                    ...
                    if (l && c.nodeType && !("click" === e.type && 1 <= e.button))
                        for (; c !== this; c = c.parentNode || this)
                            if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                                for (o = [], s = {}, n = 0; n < l; n++) void 0 === s[i = (r = t[n]).selector + " "] && (s[i] = r.needsContext ? -1 < E(i, this).index(c) : E.find(i, this, null, [c]).length), s[i] && o.push(r);
                                o.length && a.push({
                                    elem: c,
                                    handlers: o
                                })
                ...
                off: function(e, t, n) {
                    ...
                    if ("object" != Qt(e)) return !1 !== t && "function" != typeof t || (n = t, t = void 0), !1 === n && (n = Ce), this.each(function() {
            ...
            function qe(n, r, i, o) {
                ...
                var e, t, s, a, l, c, u = 0,
                    ...
                    p = r[0],
                    h = y(p);
                if (h || 1 < d && "string" == typeof p && !m.checkClone && je.test(p)) return n.each(function(e) {
                    var t = n.eq(e);
                    h && (r[0] = p.call(this, e, t.html())), qe(t, r, i, o)
                });
                if (d && (t = (e = me(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
                    for (a = (s = E.map(fe(e, "script"), Ne)).length; u < d; u++) l = e, u !== f && (l = E.clone(l, !0, !0), a && E.merge(s, fe(l, "script"))), i.call(n[u], l, u);
                    if (a)
                        for (c = s[s.length - 1].ownerDocument, E.map(s, Le), u = 0; u < a; u++) l = s[u], ue.test(l.type || "") && !Q.access(l, "globalEval") && E.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? E._evalUrl && E._evalUrl(l.src) : x(l.textContent.replace(Ae, ""), c, l))
                }
                return n
            }

            function He(e, t, n) {
                for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || E.cleanData(fe(r)), r.parentNode && (n && E.contains(r.ownerDocument, r) && pe(fe(r, "script")), r.parentNode.removeChild(r));
                return e
            }
            E.extend({
                ...
                clone: function(e, t, n) {
                    ...
                    if (!(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e)))
                        for (s = fe(u), r = 0, i = (o = fe(e)).length; r < i; r++) a = o[r], l = s[r], void 0, "input" === (c = l.nodeName.toLowerCase()) && le.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
                    if (t)
                        if (n)
                            for (o = o || fe(e), s = s || fe(u), r = 0, i = o.length; r < i; r++) Oe(o[r], s[r]);
                        else Oe(e, u);
                ...
                html: function(e) {
                    return B(this, function(e) {
                        ...
                        if ("string" == typeof e && !ke.test(e) && !de[(ce.exec(e) || ["", ""])[1].toLowerCase()]) {
                            e = E.htmlPrefilter(e);
                            try {
                                for (; n < r; n++) 1 === (t = this[n] || {}).nodeType && (E.cleanData(fe(t, !1)), t.innerHTML = e);
                                t = 0
                            } catch (e) {}
                        }
                ...
                E.fn[e] = function(e) {
                    for (var t, n = [], r = E(e), i = r.length - 1, o = 0; o <= i; o++) t = o === i ? this : this.clone(!0), E(r[o])[s](t), l.apply(n, t.get());
            ...
            function Re(e, t, n) {
                ...
                return (n = n || Ie(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || E.contains(e.ownerDocument, e) || (s = E.style(e, t)), !m.pixelBoxStyles() && Pe.test(s) && Me.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o)), void 0 !== s ? s + "" : s
            }
            ...
            function Ge(e, t, n) {
                ...
                return s = s && (m.boxSizingReliable() || i === e.style[t]), ("auto" === i || !parseFloat(i) && "inline" === E.css(e, "display", !1, r)) && (i = e["offset" + t[0].toUpperCase() + t.slice(1)], s = !0), (i = parseFloat(i) || 0) + Qe(e, t, n || (o ? "border" : "content"), s, r, i) + "px"
            }
                ...
                style: function(e, t, n, r) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        var i, o, s, a = U(t),
                            l = Be.test(t),
                            c = e.style;
                        if (l || (t = Ve(a)), s = E.cssHooks[t] || E.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : c[t];
                        "string" == (o = Qt(n)) && (i = te.exec(n)) && i[1] && (n = oe(e, t, i), o = "number"), null != n && n == n && ("number" === o && (n += i && i[3] || (E.cssNumber[a] ? "" : "px")), m.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (l ? c.setProperty(t, n) : c[t] = n))
                    }
                },
                css: function(e, t, n, r) {
                    var i, o, s, a = U(t);
                    return Be.test(t) || (t = Ve(a)), (s = E.cssHooks[t] || E.cssHooks[a]) && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = Re(e, t, r)), "normal" === i && t in $e && (i = $e[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
                }
            }), E.each(["height", "width"], function(e, a) {
                E.cssHooks[a] = {
                    get: function(e, t, n) {
                        if (t) return !ze.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ge(e, a, n) : ie(e, Fe, function() {
                            return Ge(e, a, n)
                        })
                    },
                    set: function(e, t, n) {
                        var r, i = Ie(e),
                            ...
                            s = n && Qe(e, a, n, o, i);
                        return o && m.scrollboxSize() === i.position && (s -= Math.ceil(e["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(i[a]) - Qe(e, a, "border", !1, i) - .5)), s && (r = te.exec(t)) && "px" !== (r[3] || "px") && (e.style[a] = t, t = E.css(e, a)), Ye(0, t, s)
                    }
                }
            ...
            function it() {
                Ze && (!1 === S.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(it) : C.setTimeout(it, E.fx.interval), E.fx.tick())
            }
            ...
            function lt(o, e, t) {
                var n, s, r = 0,
                    ...
                    l = function() {
                        if (s) return !1;
                        for (var e = Ke || ot(), t = Math.max(0, c.startTime + c.duration - e), n = 1 - (t / c.duration || 0), r = 0, i = c.tweens.length; r < i; r++) c.tweens[r].run(n);
                ...
                for (function(e, t) {
                        var n, r, i, o, s;
                        for (n in e)
                            if (i = t[r = U(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (s = E.cssHooks[r]) && "expand" in s)
                                for (n in o = s.expand(o), delete e[r], o) n in e || (e[n] = o[n], t[n] = i);
                            else t[r] = i
                    }(u, c.opts.specialEasing); r < i; r++)
                    if (n = lt.prefilters[r].call(c, o, u, c.opts)) return y(n.stop) && (E._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
            ...
            E.Animation = E.extend(lt, {
                ...
                tweener: function(e, t) {
                    for (var n, r = 0, i = (e = y(e) ? (t = e, ["*"]) : e.match(H)).length; r < i; r++) n = e[r], lt.tweeners[n] = lt.tweeners[n] || [], lt.tweeners[n].unshift(t)
                },
                prefilters: [function(e, t, n) {
                    ...
                    if ((l = !E.isEmptyObject(t)) || !E.isEmptyObject(p))
                        for (r in d && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = Q.get(e, "display")), "none" === (u = E.css(e, "display")) && (c ? u = c : (ae([e], !0), c = e.style.display || c, u = E.css(e, "display"), ae([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === E.css(e, "float") && (l || (f.done(function() {
                                h.display = c
                            ...
                            display: c
                        }), o && (g.hidden = !v), v && ae([e], !0), f.done(function() {
                            for (r in v || ae([e]), Q.remove(e, "fxshow"), p) E.style(e, r, p[r])
                        })), l = at(v ? g[r] : 0, r, f), r in g || (g[r] = l.start, v && (l.end = l.start, l.start = 0))
                }],
            ...
            }, et = S.createElement("input"), tt = S.createElement("select").appendChild(S.createElement("option")), et.type = "checkbox", m.checkOn = "" !== et.value, m.optSelected = tt.selected, (et = S.createElement("input")).value = "t", et.type = "radio", m.radioValue = "t" === et.value;
            ...
            E.fn.extend({
                ...
                toggleClass: function(i, t) {
                    ...
                    return "boolean" == typeof t && s ? t ? this.addClass(i) : this.removeClass(i) : y(i) ? this.each(function(e) {
                        ...
                        var e, t, n, r;
                        if (s)
                            for (t = 0, n = E(this), r = vt(i); e = r[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                        else void 0 !== i && "boolean" !== o || ((e = ht(this)) && Q.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === i ? "" : Q.get(this, "__className__") || ""))
                    })
                },
                hasClass: function(e) {
                    var t, n, r = 0;
            ...
            E.extend(E.event, {
                trigger: function(e, t, n, r) {
                    var i, o, s, a, l, c, u, d, f = [n || S],
                        p = g.call(e, "type") ? e.type : e,
                        h = g.call(e, "namespace") ? e.namespace.split(".") : [];
                    if (o = d = s = n = n || S, 3 !== n.nodeType && 8 !== n.nodeType && !mt.test(p + E.event.triggered) && (-1 < p.indexOf(".") && (p = (h = p.split(".")).shift(), h.sort()), l = p.indexOf(":") < 0 && "on" + p, (e = e[E.expando] ? e : new E.Event(p, "object" == Qt(e) && e)).isTrigger = r ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : E.makeArray(t, [e]), u = E.event.special[p] || {}, r || !u.trigger || !1 !== u.trigger.apply(n, t))) {
                        if (!r && !u.noBubble && !b(n)) {
                            for (a = u.delegateType || p, mt.test(a + p) || (o = o.parentNode); o; o = o.parentNode) f.push(o), s = o;
                            s === (n.ownerDocument || S) && f.push(s.defaultView || s.parentWindow || C)
                        }
                        for (i = 0;
                            (o = f[i++]) && !e.isPropagationStopped();) d = o, e.type = 1 < i ? a : u.bindType || p, (c = (Q.get(o, "events") || {})[e.type] && Q.get(o, "handle")) && c.apply(o, t), (c = l && o[l]) && c.apply && V(o) && (e.result = c.apply(o, t), !1 === e.result && e.preventDefault());
                        return e.type = p, r || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(f.pop(), t) || !V(n) || l && y(n[p]) && !b(n) && ((s = n[l]) && (n[l] = null), E.event.triggered = p, e.isPropagationStopped() && d.addEventListener(p, yt), n[p](), e.isPropagationStopped() && d.removeEventListener(p, yt), E.event.triggered = void 0, s && (n[l] = s)), e.result
                    }
                },
            ...
            Pt.href = bt.href, E.extend({
                ...
                ajax: function(e, t) {
                    ...
                    var u, d, f, n, p, r, h, v, i, o, g = E.ajaxSetup({}, t),
                        m = g.context || g,
                        ...
                        T = {
                            ...
                            getResponseHeader: function(e) {
                                ...
                                if (h) {
                                    if (!n)
                                        for (n = {}; t = _t.exec(f);) n[t[1].toLowerCase()] = t[2];
                                    t = n[e.toLowerCase()]
                                }
                    ...
                    if (b.promise(T), g.url = ((e || g.url || bt.href) + "").replace(Lt, bt.protocol + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = (g.dataType || "*").toLowerCase().match(H) || [""], null == g.crossDomain) {
                        r = S.createElement("a");
                        try {
                    ...
                    if (g.data && g.processData && "string" != typeof g.data && (g.data = E.param(g.data, g.traditional)), Mt(Ot, g, t, T), h) return T;
                    for (i in (v = E.event && g.global) && 0 == E.active++ && E.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !Nt.test(g.type), d = g.url.replace(jt, ""), g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(kt, "+")) : (o = g.url.slice(d.length), g.data && (g.processData || "string" == typeof g.data) && (d += (wt.test(d) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (d = d.replace(At, "$1"), o = (wt.test(d) ? "&" : "?") + "_=" + xt++ + o), g.url = d + o), g.ifModified && (E.lastModified[d] && T.setRequestHeader("If-Modified-Since", E.lastModified[d]), E.etag[d] && T.setRequestHeader("If-None-Match", E.etag[d])), (g.data && g.hasContent && !1 !== g.contentType || t.contentType) && T.setRequestHeader("Content-Type", g.contentType), T.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Ht + "; q=0.01" : "") : g.accepts["*"]), g.headers) T.setRequestHeader(i, g.headers[i]);
                    if (g.beforeSend && (!1 === g.beforeSend.call(m, T, g) || h)) return T.abort();
                    if (l = "abort", x.add(g.complete), T.done(g.success), T.fail(g.error), u = Mt(qt, g, t, T)) {
                    ...
                    function c(e, t, n, r) {
                        var i, o, s, a, l, c = t;
                        h || (h = !0, p && C.clearTimeout(p), u = void 0, f = r || "", T.readyState = 0 < e ? 4 : 0, i = 200 <= e && e < 300 || 304 === e, n && (a = function(e, t, n) {
                        ...
                        }(g, a, T, i), i ? (g.ifModified && ((l = T.getResponseHeader("Last-Modified")) && (E.lastModified[d] = l), (l = T.getResponseHeader("etag")) && (E.etag[d] = l)), 204 === e || "HEAD" === g.type ? c = "nocontent" : 304 === e ? c = "notmodified" : (c = a.state, o = a.data, i = !(s = a.error))) : (s = c, !e && c || (c = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (t || c) + "", i ? b.resolveWith(m, [o, c, T]) : b.rejectWith(m, [T, c, s]), T.statusCode(w), w = void 0, v && y.trigger(i ? "ajaxSuccess" : "ajaxError", [T, g, i ? o : s]), x.fireWith(m, [T, c]), v && (y.trigger("ajaxComplete", [T, g]), --E.active || E.event.trigger("ajaxStop")))
                    }
                    return T
                },
            ...
            m.cors = !!zt && "withCredentials" in zt, m.ajax = zt = !!zt, E.ajaxTransport(function(i) {
                var o, s;
                if (m.cors || zt && !i.crossDomain) return {
                    send: function(e, t) {
                        ...
                        o = function(e) {
                            return function() {
                                o && (o = s = r.onload = r.onerror = r.onabort = r.ontimeout = r.onreadystatechange = null, "abort" === e ? r.abort() : "error" === e ? "number" != typeof r.status ? t(0, "error") : t(r.status, r.statusText) : t(Wt[r.status] || r.status, r.statusText, "text" !== (r.responseType || "text") || "string" != typeof r.responseText ? {
                                    binary: r.response
                                } : {
                                    text: r.responseText
            ...
            E.ajaxSetup({
                ...
                if (s || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace($t, "$1" + r) : !1 !== e.jsonp && (e.url += (wt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
                    return o || E.error(r + " was not called"), o[0]
                }, e.dataTypes[0] = "json", i = C[r], C[r] = function() {
                    o = arguments
                }, n.always(function() {
                    void 0 === i ? E(C).removeProp(r) : C[r] = i, e[r] && (e.jsonpCallback = t.jsonpCallback, Ft.push(r)), o && y(i) && i(o[0]), o = i = void 0
                }), "script"
            }), m.createHTMLDocument = ((Bt = S.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Bt.childNodes.length), E.parseHTML = function(e, t, n) {
                return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (m.createHTMLDocument ? ((r = (t = S.implementation.createHTMLDocument("")).createElement("base")).href = S.location.href, t.head.appendChild(r)) : t = S), o = !n && [], (i = j.exec(e)) ? [t.createElement(i[1])] : (i = me([e], t, o), o && o.length && E(o).remove(), E.merge([], i.childNodes)));
                var r, i, o
            }, E.fn.load = function(e, t, n) {
                var r, i, o, s = this,
                    a = e.indexOf(" ");
                return -1 < a && (r = pt(e.slice(a)), e = e.slice(0, a)), y(t) ? (n = t, t = void 0) : t && "object" == Qt(t) && (i = "POST"), 0 < s.length && E.ajax({
                    url: e,
                    type: i || "GET",
                    dataType: "html",
                    data: t
                ...
                E.each({
                    ...
                    E.fn[o] = function(e, t) {
                        ...
                        return B(this, function(e, t, n) {
                            var r;
                            return b(e) ? 0 === o.indexOf("outer") ? e["inner" + s] : e.document.documentElement["client" + s] : 9 === e.nodeType ? (r = e.documentElement, Math.max(e.body["scroll" + s], r["scroll" + s], e.body["offset" + s], r["offset" + s], r["client" + s])) : void 0 === n ? E.css(e, t, i) : E.style(e, t, n, i)
                        }, a, n ? e : void 0, n)
                    }
                })
            ...
            }, E.isArray = Array.isArray, E.parseJSON = JSON.parse, E.nodeName = k, E.isFunction = y, E.isWindow = b, E.camelCase = U, E.type = w, E.now = Date.now, E.isNumeric = function(e) {
                var t = E.type(e);
    ...
    e.exports = function(r, n, e) {
        ...
        return n = x(n) || 0, y(e) && (d = !!e.leading, s = (f = "maxWait" in e) ? w(x(e.maxWait) || 0, n) : s, t = "trailing" in e ? !!e.trailing : t), m.cancel = function() {
    ...
    e.exports = {
        scrollBarWidth: function() {
            ...
            t.style.visibility = "hidden", t.style.width = "100px", t.style.overflow = "scroll", t.appendChild(n), e.appendChild(t);
            var r = t.offsetWidth,
                i = n.offsetWidth;
    ...
    function r(t) {
        var f, n, r, i, o, s = L((t = t || {}).container, document.querySelector("*[data-simple-slider]")),
            p = L(t.prop, "left"),
            a = 1e3 * L(t.duration, .5),
            l = 1e3 * L(t.delay, 3),
            h = L(t.unit, "%"),
            c = L(t.init, -100),
            u = L(t.show, 0),
        ...
        function b() {
            if (0 < O(s.children)) {
                var e = s.style;
                e.position = "relative", e.overflow = "hidden", e.display = "block", i = function(e, t, n, r, i, o) {
                    var s = [];
                    t || (t = e.children);
                    for (var a = O(t); 0 <= --a;) s[a] = t[a];
                    return s
                }(s, t.children), f = 0, o = l
            }
        }

        function x() {
            w() && (n && clearTimeout(n), function e() {
                r = y(), n = setTimeout(function() {
                    r = y(), o = l, S(k()), e()
                }, o)
            }())
        }
        ...
        function S(e) {
            ...
            ! function t(n, r, i, o, s, a, l, c, u, d) {
                ...
                if (0 < c) {
                    if (!(u - c < l)) return n[p] = i + h, o[p] = a + h, void(m && m(f, k()));
                    e(n, r, i), e(o, s, a)
                }
                requestAnimationFrame(function(e) {
                    0 === c && (c = e), t(n, r, i, o, s, a, l, c, e, d)
                })
            }(i[f].style, u, d, i[e].style, c, u, a, 0, 0, v), f = e, g && g(j(), f)
        }
        ...
        function A() {
            clearTimeout(n), document.removeEventListener("visibilitychange", N), i = s = n = p = a = l = c = d = e = f = o = g = m = null
        }
        ...
        return document.addEventListener("visibilitychange", N), b(), i && 1 < O(i) && x(), {
            internalState: {
    ...
    n.r(t), n.d(t, "getSlider", function() {
        return r
    })
}, function(e, t, n) {
    e.exports = n(23)
    ...
    var r, i, o;
    n(0);
    i = [n(0)], void 0 === (o = "function" == typeof(r = function(m) {
        "use strict";
        var y = {
            data: {
                index: 0,
        ...
        var r = {
            ...
            e = function(e) {
                y.scroll || (y.overlay = function() {
                ...
                }(), y.scroll = n(), c(), m(window).resize(function() {
                    var e = !1;
                    ...
                    c(e)
                })), this.container = e, this.namespace = ".scrollbar_" + y.data.index++, this.options = m.extend({}, r, window.jQueryScrollbarOptions || {}), this.scrollTo = null, this.scrollx = {}, this.scrolly = {}, e.data(y.data.name, this), y.scrolls.add(this)
            };
        e.prototype = {
            destroy: function() {
                if (this.wrapper) {
            ...
            init: function(e) {
                ...
                if (y.mobile && v.ignoreMobile || y.overlay && v.ignoreOverlay || y.macosx && !y.webkit) return m.isFunction(v.onFallback) && v.onFallback.apply(this, [p]), !1;
                if (n)(t = {
                    height: "auto",
                    "margin-bottom": -1 * y.scroll.height + "px",
                    "max-height": ""
                })[v.isRtl ? "margin-left" : "margin-right"] = -1 * y.scroll.width + "px", i.css(t);
                else {
                    if (this.wrapper = n = m("<div>").addClass("scroll-wrapper").addClass(p.attr("class")).css("position", "absolute" === p.css("position") ? "absolute" : "relative").insertBefore(p).append(p), v.isRtl && n.addClass("scroll--rtl"), p.is("textarea") && (this.containerWrapper = i = m("<div>").insertBefore(p).append(p), n.addClass("scroll-textarea")), (t = {
                            height: "auto",
                            "margin-bottom": -1 * y.scroll.height + "px",
                            "max-height": ""
                        })[v.isRtl ? "margin-left" : "margin-right"] = -1 * y.scroll.width + "px", i.addClass("scroll-content").css(t), p.on("scroll" + h, function(e) {
                            var t = p.scrollLeft(),
                                n = p.scrollTop();
                            if (v.isRtl) switch (!0) {
                                case y.firefox:
                            ...
                            m.isFunction(v.onScroll) && v.onScroll.call(f, {
                                ...
                                size: g.x.size,
                                visible: g.x.visible
                            }), g.x.isVisible && g.x.scroll.bar.css("left", t * g.x.kx + "px"), g.y.isVisible && g.y.scroll.bar.css("top", n * g.y.kx + "px")
                        ...
                        n.on("MozMousePixelScroll" + h, o), n.on("mousewheel" + h, o), y.mobile && n.on("touchstart" + h, function(e) {
                            ...
                            m(document).on("touchmove" + h, function(e) {
                                ...
                                p.scrollLeft(r.left + n.pageX - t.pageX), p.scrollTop(r.top + n.pageY - t.pageY), e.preventDefault()
                ...
                m.each(g, function(i, o) {
                    var s = null,
                        ...
                        u = function() {
                            var e = p[l]();
                            p[l](e + c), 1 == a && d <= e + c && (e = p[l]()), -1 == a && e + c <= d && (e = p[l]()), p[l]() == e && s && s()
                        },
                        d = 0;
                    o.scroll || (o.scroll = f._getScroll(v["scroll" + i]).addClass("scroll-" + i), v.showArrows && o.scroll.addClass("scroll-element_arrows_visible"), o.mousewheel = function(e) {
                        ...
                        return t || ("x" === i && e.originalEvent.deltaX ? t = 40 * e.originalEvent.deltaX : "y" === i && e.originalEvent.deltaY && (t = 40 * e.originalEvent.deltaY)), (0 < t && d < n || t < 0 && 0 < d) && ((d += t) < 0 && (d = 0), n < d && (d = n), f.scrollTo = f.scrollTo || {}, f.scrollTo[l] = d, setTimeout(function() {
                        ...
                        if (m(this).hasClass("scroll-arrow")) {
                            if (a = m(this).hasClass("scroll-arrow_more") ? 1 : -1, c = v.scrollStep * a, d = 0 < a ? t.maxScrollValue : 0, v.isRtl) switch (!0) {
                                case y.firefox:
                                    d = 0 < a ? 0 : -1 * t.maxScrollValue;
                                    break;
                                case y.msie || y.msedge:
                            }
                        } else a = t.scrollbarOffset + t.scrollbarSize < t.eventOffset ? 1 : t.eventOffset < t.scrollbarOffset ? -1 : 0, "x" === i && v.isRtl && (y.msie || y.msedge) && (a *= -1), c = Math.round(.75 * o.visible) * a, d = t.eventOffset - t.scrollbarOffset - (v.stepScrolling ? 1 == a ? t.scrollbarSize : 0 : Math.round(t.scrollbarSize / 2)), d = p[l]() + d / o.kx;
                        return f.scrollTo = f.scrollTo || {}, f.scrollTo[l] = v.stepScrolling ? p[l]() + c : d, v.stepScrolling && (s = function() {
                            d = p[l](), clearInterval(r), clearTimeout(n), r = n = 0
                        }, n = setTimeout(function() {
                            r = setInterval(u, 40)
                        }, v.duration + 100)), setTimeout(function() {
                            f.scrollTo && (p.animate(f.scrollTo, v.duration), f.scrollTo = null)
                        }, 1), f._handleMouseDown(s, e)
                    }), o.scroll.bar.on("mousedown" + h, function(e) {
                        if (1 != e.which) return !0;
                        var n = e["x" === i ? "pageX" : "pageY"],
                            r = p[l]();
                        return o.scroll.addClass("scroll-draggable"), m(document).on("mousemove" + h, function(e) {
                            var t = parseInt((e["x" === i ? "pageX" : "pageY"] - n) / o.kx, 10);
                            "x" === i && v.isRtl && (y.msie || y.msedge) && (t *= -1), p[l](r + t)
                        }), f._handleMouseDown(function() {
                            o.scroll.removeClass("scroll-draggable"), d = p[l]()
                        }, e)
                    }))
                }), m.each(g, function(e, t) {
                    var n = "scroll-scroll" + e + "_visible",
                        r = "x" == e ? g.y : g.x;
                    t.scroll.removeClass(n), r.scroll.removeClass(n), i.removeClass(n)
                }), m.each(g, function(e, t) {
                    m.extend(t, "x" == e ? {
                ...
                }), this._updateScroll("x", this.scrollx), this._updateScroll("y", this.scrolly), m.isFunction(v.onUpdate) && v.onUpdate.apply(this, [p]), m.each(g, function(e, t) {
                    var n = "x" === e ? "left" : "top",
                    ...
                    v.autoScrollSize && (t.scrollbarSize = parseInt(l * a / s, 10), t.scroll.bar.css(i, t.scrollbarSize + "px")), t.scrollbarSize = t.scroll.bar[r](), t.kx = (l - t.scrollbarSize) / (s - a) || 1, t.maxScrollOffset = s - a
            ...
            _getScroll: function(e) {
                ...
                return t[e] && (e = t[e]), e || (e = t.simple), e = "string" == typeof e ? m(e).appendTo(this.wrapper) : m(e), m.extend(e, {
            ...
            _updateScroll: function(e, t) {
                var n = this.container,
                    ...
                    l = t.size,
                    c = t.visible + s;
                t.isVisible = 1 < l - c, t.isVisible ? (t.scroll.addClass(i), o.scroll.addClass(i), r.addClass(i)) : (t.scroll.removeClass(i), o.scroll.removeClass(i), r.removeClass(i)), "y" === e && (n.is("textarea") || l < c ? r.css({
        ...
        m.fn.scrollbar = function(n, r) {
            return "string" != typeof n && (r = n, n = "init"), void 0 === r && (r = []), m.isArray(r) || (r = [r]), this.not("body, .scroll-wrapper").each(function() {
                var e = m(this),
                    t = e.data(y.data.name);
                (t || "init" === n) && (t || (t = new i(e)), t[n] && t[n].apply(t, r))
            }), this
        ...
        var c = function() {
            ...
            return function(e) {
                var t, n, r, i, o, s, a;
                for (t = 0; t < y.scrolls.length; t++) i = y.scrolls[t], n = i.container, r = i.options, o = i.wrapper, s = i.scrollx, a = i.scrolly, (e || r.autoUpdate && o && o.is(":visible") && (n.prop("scrollWidth") != s.size || n.prop("scrollHeight") != a.size || o.width() != s.visible || o.height() != a.visible)) && (i.init(), r.debug && window.console);
        ...
        function n(e) {
            ...
            if (!y.data.outer) {
                ...
                y.data.inner = m("<div>").css(m.extend({}, t)), y.data.outer = m("<div>").css(m.extend({
                    left: "-1000px",
                    overflow: "scroll",
                    position: "absolute",
                    top: "-1000px"
    ...
    var n;
    n = document.querySelector("html"), "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch ? n.classList.add("is-touchDevice") : n.classList.add("no-touchDevice")
}, function(e, t, n) {
    "use strict";
    n.r(t);
    var r = n(1),
    ...
    function s() {
        o.setAttribute("content", "width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0"), window.matchMedia("screen and (max-width: 380px)").matches && o.setAttribute("content", "width=380")
    }
    s()
}, function(e, t, n) {
    var r = n(4);
    ...
    ! function(t) {
        "use strict";
        var n = function(e) {
                e.preventDefault(), r.removeClass("sidebar-open"), t(".bm-sidebar-shade").fadeOut(150), setTimeout(function() {
                    t(".bm-sidebar-shade").remove()
                }, 150)
            },
            r = t("body");
        t(document).on("click", "[data-toggleclass]", function(e) {
            e.preventDefault(), t(t(this).attr("data-target")).toggleClass(t(this).attr("data-toggleClass")), r.append(t("<div>", {
                class: "bm-sidebar-shade"
            })), t(".bm-sidebar-shade").click(function(e) {
                n(e)
            })
        }), t(".js-scrollbar").scrollbar(), t(document).on("click", ".bm-close-sidebar", function(e) {
            n(e)
            ...
            return function(e) {
                function c() {
                    for (var e = 0; e < h.length;) {
                        ...
                        if (!i && d.attributeName && (i = t.getAttribute(d.attributeName)), r && i) {
                            if (u)
                                if (!d.validate || d.validate(i, r, t)) {
                                    ...
                                    if (s.length) {
                                        var l = f[s];
                                        l || ((l = f[s] = new XMLHttpRequest).open("GET", s), l.send(), l._embeds = []), l._embeds.push({
                                            parent: n,
                                            svg: r,
                                            id: a
                                        }), m(l)
            ...
            if (a) {
                for (var r = document.querySelectorAll(".slider__item"), i = document.querySelectorAll(".slider__page-item"), o = null, l = u.getSlider({
                        ...
                        onChange: function(e, t) {
                            null !== o ? r[o].classList.add("slider__item--outing") : r[e].classList.add("slider__item--outing"), r[t].classList.add("slider__item--coming");
                            for (var n = 0; n < i.length; ++n) i[n].classList.remove("slider__page-item--active");
                            i[t].classList.add("slider__page-item--active"), s(t, a)
                        },
                        onChangeEnd: function(e, t) {
                            for (var n = 0; n < r.length; ++n) r[n].classList.remove("slider__item--outing"), r[n].classList.remove("slider__item--active");
                            r[o = e].classList.remove("slider__item--coming"), r[e].classList.add("slider__item--active"), document.hidden && l.pause()
                        }
                    }), e = 0; e < i.length; ++e) i[e].addEventListener("click", function() {
                    var e = this.getAttribute("data-index");
                    l.currentIndex() !== 1 * e && (l.change(1 * e), l.__simpleslider_paused || l.resume())
                });
                ...
                var t = 0,
                    n = function() {
                        t && (clearTimeout(t), t = 0), t || (t = setTimeout(function() {
                            t = 0,
                                function() {
                                    ...
                                    var o = (t = Math.max(0, t)) / n,
                                        s = t / e.height;
                                    .5 <= Math.max(s, o) ? l.__simpleslider_paused && (l.resume(), l.__simpleslider_paused = !1) : l.__simpleslider_paused || (l.pause(), l.__simpleslider_paused = !0)
                                }()
                        }, 250))
                    };
                document.querySelector(".page").addEventListener("scroll", n), window.addEventListener("resize", n), n()
            }
        ...
        a = function() {
            ...
            if (a) {
                for (var i = document.querySelectorAll(".slider-price__item"), r = document.querySelectorAll(".slider-price__page-item"), o = null, l = f.getSlider({
                        ...
                        duration: .3,
                        onChange: function(e, t) {
                            null !== o ? i[o].classList.add("slider-price__item--outing") : i[e].classList.add("slider-price__item--outing"), i[t].classList.add("slider-price__item--coming");
                            for (var n = 0; n < r.length; ++n) r[n].classList.remove("slider-price__page-item--active");
                            r[t].classList.add("slider-price__page-item--active"), a.setAttribute("data-active", l.currentIndex())
                        },
                        onChangeEnd: function(e, t) {
                            for (var n = 0; n < i.length; ++n) i[n].classList.remove("slider-price__item--outing"), i[n].classList.remove("slider-price__item--active");
                            i[o = e].classList.remove("slider-price__item--coming"), i[e].classList.add("slider-price__item--active"), document.hidden && l.pause()
                        }
                    }), e = 0; e < r.length; ++e) r[e].addEventListener("click", function() {
                    var e = this.getAttribute("data-index");
                    l.currentIndex() !== 1 * e && (l.change(1 * e), l.__simpleslider_paused || l.resume())
                });
